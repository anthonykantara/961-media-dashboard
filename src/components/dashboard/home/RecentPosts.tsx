    ...
    <div className="bg-white p-6 rounded-xl border border-gray-100 flex flex-col h-auto">
      ...
      <div className="space-y-5">
        {recentList.map((post) => (
          ...
          >
            <div className="w-12 h-12 rounded-lg bg-gray-100 overflow-hidden shrink-0 border border-gray-100 flex items-center justify-center">
              {post.image ? (
                <img 
                  src={post.image} 
                  alt={post.title} 
                ...
                <span className="text-[9px] font-semibold text-gray-300">No image</span>
              )}
            </div>
            ...
            <div className="text-right shrink-0">
              <p className="text-sm font-semibold text-gray-900 tracking-tight">{post.views || '0'}</p>
